...
router.post(
  "/",
  [
    check("familyLastName", "Family Last Name is required")
      .not()
      .isEmpty(),
    ...
    check("unit", "Please select Unit")
      .not()
      .isEmpty(),
    check("hutNumber1", "Hut number is incorrect")
      .not()
      .isEmpty(),
    check("district", "incorrect district entered")
      .not()
      .isEmpty(),
    check("village", "incorrect village entered")
      .not()
      .isEmpty(),
    check("country", "Please select country")
      .not()
      .isEmpty(),
    check("state", "state is incomplete")
      .not()
      .isEmpty(),
    ...
    check("members", "Atleast one member should be listed")
      .not()
      .isEmpty()
  ],
  async (req, res) => {
    ...
    try {
      ...
      if (hut) {
        res
          .status(400)
          .json({ errors: [{ msg: "This hut is already registered" }] });
      } else {
        hut = new Huts({
          familyLastName,
          camp,
